...
public typealias ActionTrainerFeatures = ScratchLabML.ActionTrainerFeatures

extension ScratchLabML.ActionTrainerFeatures {
    /// Tool-only loaded-dataset adapter. The actual transform is shared.
