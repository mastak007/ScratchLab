        ...
        ZStack {
            ...
            ScrollView(showsIndicators: true) {
                VStack(alignment: .leading, spacing: 18) {
                    header
                    feedbackCard
                    // The visible 2D coach rig has been removed app-wide. Demo Mode remains
                    // as a non-avatar demo/training surface, and the text-based coaching
                    // card (`ScratchCoachCardContent`) is still available on the surfaces
                    // that mount it.
                    exportCard
                }
                .padding(.horizontal, 20)
